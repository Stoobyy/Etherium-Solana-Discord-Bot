...
@client.event
async def on_ready():
    await client.change_presence(status=discord.Status.idle, activity=discord.Activity(type=discord.ActivityType.watching, name="the server for !help"))
...
async def register(ctx,address=None):
  if address==None:
    embed=discord.Embed(title='No address provided.',color=16776960)
    ...
    embed.set_author(name='NFTCop - Whitelist Bot',icon_url='https://media.discordapp.net/attachments/952897404309491742/952949809025802311/unknown_2.png') 
    embed.set_thumbnail(url='https://media.discordapp.net/attachments/952897404309491742/952949809025802311/unknown_2.png')
    await ctx.send(embed=embed)
  else:
    response=requests.get(f'https://api.etherscan.io/api?module=account&action=balance&address={address}&tag=latest&apikey=ZPJWJH73DWBTB1B83N5M3E5CD968KXAB91')
    raw=response.json()
    result=raw['result']
    try:
      result=float(result)
      ...
      if (result/1000000000000000000)>=min:
        ...
        if ctx.author.id not in already:
          if str(ctx.guild.id) in accounts:
            if address in accounts[str(ctx.guild.id)][0]: 
              embed=discord.Embed(title='Duplicate Entry',color=16776960)
              ...
              embed=discord.Embed(title='Successfully registered.',color=16776960)
          ...
          embed=discord.Embed(title='Error!',color=16776960)
          embed.add_field(name='You cannot register twice.',value=f'\n\n\n<:unknown_2:952949819612217454> [Our Website](http://nftcop.io)\n<:instagram:952950025737080892> [Our Instagram](https://www.instagram.com/nftcop.io/)\n<:Twitter:952950111548370995> [Our Twitter](https://twitter.com/mynftcop)',inline=False)
          embed.set_author(name='NFTCop - Whitelist Bot',icon_url='https://media.discordapp.net/attachments/952897404309491742/952949809025802311/unknown_2.png') 
          embed.set_thumbnail(url='https://media.discordapp.net/attachments/952897404309491742/952949809025802311/unknown_2.png')
          await ctx.send(embed=embed)
      else:
        embed=discord.Embed(title='Insufficient balance on account.',color=16776960)
      ...
      embed=discord.Embed(title='Invalid Ether Address!',color=16776960)
      embed.add_field(name='Please rerun the command.',value=f'\n\n\n<:unknown_2:952949819612217454> [Our Website](http://nftcop.io)\n<:instagram:952950025737080892> [Our Instagram](https://www.instagram.com/nftcop.io/)\n<:Twitter:952950111548370995> [Our Twitter](https://twitter.com/mynftcop)',inline=False)
      embed.set_author(name='NFTCop - Whitelist Bot',icon_url='https://media.discordapp.net/attachments/952897404309491742/952949809025802311/unknown_2.png') 
      embed.set_thumbnail(url='https://media.discordapp.net/attachments/952897404309491742/952949809025802311/unknown_2.png')
      await ctx.send(embed=embed)
...
async def view(ctx):
  with open('accounts.txt','r') as a:
    accs=json.load(a)
  try:
    embed=discord.Embed(title='All addresses',color=16776960)
    ...
    embed=discord.Embed(title='No Addresses found!',color=16776960)
    embed.add_field(name='Socials:',value=f'\n\n\n<:unknown_2:952949819612217454> [Our Website](http://nftcop.io)\n<:instagram:952950025737080892> [Our Instagram](https://www.instagram.com/nftcop.io/)\n<:Twitter:952950111548370995> [Our Twitter](https://twitter.com/mynftcop)',inline=False)
    embed.set_author(name='NFTCop - Whitelist Bot',icon_url='https://media.discordapp.net/attachments/952897404309491742/952949809025802311/unknown_2.png') 
    await ctx.send(embed=embed)
...
async def balance(ctx):
  ...
  embed=discord.Embed(title=f'Current balance is {balance}',color=16776960)
  embed.add_field(name='Socials:',value=f'\n\n\n<:unknown_2:952949819612217454> [Our Website](http://nftcop.io)\n<:instagram:952950025737080892> [Our Instagram](https://www.instagram.com/nftcop.io/)\n<:Twitter:952950111548370995> [Our Twitter](https://twitter.com/mynftcop)',inline=False)
  embed.set_author(name='NFTCop - Whitelist Bot',icon_url='https://media.discordapp.net/attachments/952897404309491742/952949809025802311/unknown_2.png') 
  await ctx.send(embed=embed)
...
async def export(ctx):
  ...
  with open('accounts1.txt','w') as b:
...
@commands.has_permissions(manage_messages=True)
async def help(ctx):
  embed=discord.Embed(title='Help Menu',color=16776960)
  ...
  embed.add_field(name='-balance',value='Shows the currently set minimum balance')
  embed.add_field(name='-remove',value='Removes an address from the database')
  embed.add_field(name='-list',value='Lists all addresses along with balance')
